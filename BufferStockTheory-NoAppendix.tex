...
Strict concavity and continuous differentiability of the consumption function are key elements in many of the arguments below, but are not characteristics of models with `artificial' borrowing constraints.  The analytical convenience of these features is considerable, given that models with natural borrowing constraints usually give similar results to those with artificial constraints.
...
\begin{comment}  % Proofs sketched below
