...
\begin{theorem}
 ...
 The full proof is in Appendix~\ref{sec:MTargetIsStable}, but the key points can be made informally here.  Defining $\bar{\Rnorm}=(\Rfree/\PGroAdj)$, since $\Ex_{t}[\mRat_{t+1}]=\bar{\Rnorm}(\mRat_{t}-\cRat_{t})+1$, the implicit equation for $\mTarg$ is 
 \begin{align}
