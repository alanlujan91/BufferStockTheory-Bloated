...
\renewcommand{\forcedate}{July 30, 2021}\date{\forcedate} % Alternative is \date{\today}
...
\hypertarget{GPFRaw}{}
\hypertarget{GICRaw}{}
By analogy to the return patience factor, we therefore define a `growth patience factor' (\GPFRaw) as
\begin{align}
