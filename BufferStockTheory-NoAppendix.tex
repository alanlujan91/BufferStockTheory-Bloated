...
\renewcommand{\forcedate}{September 16, 2021}\date{\forcedate}
...
%\onlyinsubfile{\bibliography{BufferStockTheory,./LaTeX/economics}}\end{document}
%\endinput
...
\onlyinsubfile{\bibliography{BufferStockTheory,./LaTeX/economics}}
\end{document}
\endinput
