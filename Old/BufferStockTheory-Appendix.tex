\input{./econtexRoot}\documentclass[titlepage]{\econtex}\providecommand{\texname}{BufferStockTheory-Appendix}% Indicate the keyname for the bibtex entry corresponding to this paper
...
\bibliography{\econtexRoot/LaTeX/BufferStockTheory,\econtexBib}
