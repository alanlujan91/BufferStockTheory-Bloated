\documentclass[\econtexRoot/BufferStockTeory.tex]{subfiles}\input{./econtexRoot} % Switch root to subdirectory 
%\onlyinsubfile{\externaldocument{\econtexRoot/BufferStockTheory}}
