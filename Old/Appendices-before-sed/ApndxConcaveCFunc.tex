\input{./econtexRoot}\documentclass[\econtexRoot/BufferStockTeory.tex]{subfiles}\input{./econtexRoot}
\begin{document}
...
three times continuously differentiable, using \eqref{eq:consumptionf} we can conclude that
...
or absence of time subscripts on the MPC's.)
  We have therefore
not proven (yet) that the sequence of value functions \eqref{eq:veqn} defines a contraction mapping.
