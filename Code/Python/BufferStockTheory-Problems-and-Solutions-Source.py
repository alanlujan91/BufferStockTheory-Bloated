...
#
# \begin{equation*}
# \vLev_{t}^{\text{autarky}} = u(\pLev_{t})\left(\frac{1}{1-\DiscFac \PermGroFac^{1-\CRRA} \Ex[\permShk^{1-\CRRA}]}\right)
# \end{equation*}
#
...
#
# ### [If the GIC-Nrm Holds, $\exists$ a finite 'target' $\Trg{\mNrm}$](https://econ-ark.github.io/BufferStockTheory/#onetarget)
#
...
#
# ### [If the GIC Holds, $\exists$ a finite 'pseudo-steady-state' $\StE{\mNrm}$](https://econ-ark.github.io/BufferStockTheory/#Collective-Stability)
#
...
#
#
# ### [Example With Finite Pseudo-Steady-State $\StE{\mNrm}$ But Infinite Target Wealth $\Trg{\mNrm}$](https://econ-ark.github.io/BufferStockTheory/#GICNrmFailsButGICRawHolds)
#
...
# Create the agent
RichButPatientAgent = PerfForesightConsumerType(**PFGICRawHoldsFHWCFailsRICFails_par)
# Check conditions
