...
if mNrmTrg:  # Do not try to plot it if it does not exist!
    ax.text(mNrmTrg-0.01, 1.0-0.001, 
            r'$1.00 = \Ex_{t}[\mRat_{t+1}/\mRat_{t}]:~ \Trg{m} \rightarrow~~$', ha='right')
...
ax.text(mTrgGro_lbl_xVal-0.01, mTrgGro_lbl_yVal-0.003,mRatGro_lbl,va='bottom',ha='right')
...
# %% [markdown] {"tags": [], "heading_collapsed": "true", "jupyter": {"source_hidden": true}}
