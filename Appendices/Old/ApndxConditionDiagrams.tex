...
\begin{document}
  ...
  \centerline{\includegraphics{\tikzFigs/GICRaw-vs-RIC-vs-FHWC}}
% \[
%   \begin{tikzcd}[row sep=large, column sep=large]
%   \textbf{\Thorn} \ar{rr}{\mathrm{\GICRaw}} \ar{dr}{\mathrm{\RIC}}& & \Gamma \ar{dl}{\mathrm{\FHWC}} \\
%    & \mathsf{\Rfree} &
%   \end{tikzcd}
% \]
  ...
  \centerline{\includegraphics{\tikzFigs/GICRaw-vs-RIC-vs-FHWC-vs-FVAC}}
  
% \[
%   \begin{tikzcd}[row sep=huge, column sep=huge]
%   \textbf{\Thorn} \ar{r}{\mathrm{\GICRaw}} \ar{d}{\mathrm{\RIC}} \ar{dr}{\mathrm{\PFFVAC}}& \Gamma \ar{d}{\mathrm{\FHWC}} \\
