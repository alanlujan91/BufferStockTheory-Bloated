...
%\onlyinsubfile{\pagebreak\bibliography{\LaTeXGenerated/BufferStockTheory,\econtexBib}}\end{document}\end{document}
...
\onlyinsubfile{\pagebreak\bibliography{\LaTeXGenerated/BufferStockTheory,\econtexBib}}\end{document}
