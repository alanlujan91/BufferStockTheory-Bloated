...
\newlength{\ComparisonSubShrunk}
\newsavebox{\ComparisonSubShrunkBox}

\savebox{\ComparisonSubShrunkBox}{
  \settowidth{\ComparisonSubShrunk}{\usebox{\ComparisonSub}}
  \resizebox{0.95\textwidth}{!}{\begin{minipage}{\ComparisonSubShrunk}
      \usebox{\ComparisonSub}
    \end{minipage}}
}

%\usebox{\ComparisonSub}
\usebox{\ComparisonSubShrunkBox}
